...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '715fb113cfa379b619b0b83b357b411a'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'write_orders,read_shipping, write_shipping, read_orders,
      read_shipping, read_script_tags, write_script_tags'),
    /*
    |--------------------------------------------------------------------------
